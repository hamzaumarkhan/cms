                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" class="form-control">
                        ...
                        while($c_rows = mysqli_fetch_assoc($run_sql)) {
                            ...
                            echo '<option value="'.$c_rows['category_name'].'" >'.$c_rows['category_name'].'</option>';
                        }
                        ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control"><?php echo $rows['description']; ?></textarea>
                    </div>
                    <div class="form-group">
