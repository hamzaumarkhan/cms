                    ...
                    while($rows = mysqli_fetch_assoc($run_cat)) {
                        ...
                        if($rows['category_name'] == 'home') {
                            if($_SERVER['PHP_SELF'] == '/cms/index.php') {
                               echo '<li class="active"><a href="index.php">'.usfirst($rows['category_name']).'</a>';
                            } else {
                                echo '<li class=""><a href="index.php">'.usfirst($rows['category_name']).'</a>';
                            }

                            } else {
                        echo '<li class="'.$class.'"><a href="menu.php?cat_name='.$rows['category_name'].'">'($rows['category_name']).'</a></li>';
                            }
                         }
                        }
                    ?>
